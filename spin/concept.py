...
# encoding: utf-8
'''
concept.py -- Nymology ConceptNet NLP tools
'''
...
### METHODS
def relatednesses(li):
    'compare concepts list'
    for a, b in combinations(li):
        print(f'{a}::{b}={relatedness(a,b)}')
