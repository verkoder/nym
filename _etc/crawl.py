...
from spin.models import Fortune, Quadranym, Quote
...
def find_quotes(span=2):
    ...
    print(f'{len(batch)} Quotes loaded. Searching {i}:{o} from {len(dims)} Q-dimensions')
    ...
    pickle.dump(batch, open('quotes.pkl', 'wb'))
    print(f'{len(batch)} Quotes loaded!')
